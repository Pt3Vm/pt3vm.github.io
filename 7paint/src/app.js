...
Object.defineProperty(window, 'selected_colors', {
     get: () => selected_colors,
     set: (v) => { selected_colors = v; },
     configurable: true,
 });
 Object.defineProperty(window, 'selected_tool', {
     get: () => selected_tool,
     set: (v) => { selected_tool = v; },
     configurable: true,
 })
// #endregion
...
const ribbon_mode = true; // Forcing ribbon mode for Windows 7 fork
let $ribbon;
if (ribbon_mode) {
	$("body").addClass("ribbon-ui");
	$ribbon = $Ribbon();
	$ribbon.prependTo($V);
	prevent_selection($ribbon);
}
